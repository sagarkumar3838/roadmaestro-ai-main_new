window.ramp.que.push(function(){window.ramp.addTag("pwDeskLbBtf1")})
...
#### [#](#jquery-removeclass)jQuery removeClass
...
### [#](#miscellaneous-traversing)Miscellaneous Traversing
...
#### [#](#prevents-the-event)Prevents the event
...
*   [jQuery.support](https://api.jquery.com/jQuery.support/)
...
### [#](#dom-element-methods)DOM Element Methods
...
*   [.context](https://api.jquery.com/context/)
...
window.ramp.que.push(function(){window.ramp.addTag("pwDeskMedRectBtf3")})