...
export default function OGLContentDeveloperCourse() {
  ...
  return (
    <div className="h-full p-6 space-y-6">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold">OGL Content Developer Course</h1>
        <p className="text-xl text-gray-600 dark:text-gray-400">
          Learn to create and manage content for Oracle Global Learning Platforms
        </p>
      </div>
