...
interface DropdownCardProps {
  tech?: 'html' | 'css' | 'js' | 'nodejs' | 'expressjs' | 'mongodb' | 'reactjs' | 'heroku';
}

const DropdownCard: React.FC<DropdownCardProps> = ({ tech }) => {
  const logos = {
    html: (
  ...
  if (tech === 'html') {
    return (
      <div>
        {/* Original HTML content moved here */}
...
const StyledWrapper = styled.div`
  ...
  .popup {
    --burger-line-width: 0.325em;
    --burger-line-height: 0.125em;
    --burger-offset: 0.625em;
    
    --burger-color: #b59e9e;
    --burger-line-border-radius: 0.175em;
    --burger-diameter:4em;
    --burger-btn-border-radius: calc(var(--burger-diameter) / 9);
    ...
    --nav-shadow-color: rgba(68, 68, 68, 0.2);
